...
START_TEST(test_mgr_unmap_add_keys)
{
    ...
    // Try to add keys now
    char *keys[] = {(char*)"hey",(char*)"there",(char*)"person"};
    res = setmgr_set_keys(mgr, (char*)"zab5", (char**)&keys, 3, time(NULL));
    fail_unless(res == 0);
...
START_TEST(test_mgr_clear_reload)
{
    ...
    // Try to add keys now
    char *keys[] = {(char*)"hey",(char*)"there",(char*)"person"};
    res = setmgr_set_keys(mgr, (char*)"zab9", (char**)&keys, 3, time(NULL));
    fail_unless(res == 0);
...
START_TEST(test_mgr_list_cold)
{
    ...
    char *keys[] = {(char*)"hey",(char*)"there",(char*)"person"};
    res = setmgr_set_keys(mgr, (char*)"zab6", (char**)&keys, 3, time(NULL));
    fail_unless(res == 0);
...
START_TEST(test_mgr_unmap_in_mem)
{
    ...
    // Try to add keys now
    char *keys[] = {(char*)"hey",(char*)"there",(char*)"person"};
    res = setmgr_set_keys(mgr, (char*)"mem1", (char**)&keys, 3, time(NULL));
    fail_unless(res == 0);
